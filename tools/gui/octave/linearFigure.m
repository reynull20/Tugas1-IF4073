function linearFigure (loadimage, im)
  fig = figure("name", "Linear Histogram");
  ...
  uicontrol(panel, "style", "text", "string", "A:", "units", "normalized", "position", [0, 0.5, 0.025, 0.5], "horizontalalignment", "left");
  txt1 = uicontrol(panel, "style", "edit", "string", "1", "units", "normalized", "position", [0.025, 0.5, 0.475, 0.5], "horizontalalignment", "left");
  uicontrol(panel, "style", "text", "string", "B:", "units", "normalized", "position", [0.5, 0.5, 0.025, 0.5], "horizontalalignment", "left");
  txt2 = uicontrol(panel, "style", "edit", "string", "0", "units", "normalized", "position", [0.525, 0.5, 0.475, 0.5], "horizontalalignment", "left");
  ctrls = [txt1, txt2];
...
function draw (fig, hax, ctrls)
  im = get(fig, "userdata");
  a = real(str2double(get(ctrls(1), "string")));
  b = real(str2double(get(ctrls(2), "string")));
